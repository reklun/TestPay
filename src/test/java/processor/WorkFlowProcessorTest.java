...
public class WorkFlowProcessorTest {
    ...
    public void test1() throws IOException {
        ...
        final String test1 = "src/test/resources/data/test1/input";
...
//    8, 22-01-2019 14:00:00, ON, Stop1, Company1, Bus38, 5500005555555562
    ...
    public void test2() throws IOException {
        ...
        final String test2 = "src/test/resources/data/test2/input";
//        ID, DateTimeUTC, TapType, StopId, CompanyId, BusID, PAN
//        1, 22-01-2018 13:00:00, ON, Stop1, Company1, Bus37, 5500005555555559
//        3, 22-01-2018 18:00:00, ON, Stop2, Company1, Bus37, 5500005555555559
...
//        results.forEach(System.out::println);
    ...
    @Test // within the same day same bus same company ID and PAN, the OFF match to closest record
    public void test3() throws IOException {

        final String test2 = "src/test/resources/data/test3/input";
//        ID, DateTimeUTC, TapType, StopId, CompanyId, BusID, PAN
//        1, 22-01-2018 13:00:00, ON, Stop1, Company1, Bus37, 5500005555555559
//        3, 22-01-2018 18:00:00, ON, Stop2, Company1, Bus37, 5500005555555559
//        4, 22-01-2018 18:01:00, OFF, Stop2, Company1, Bus37, 5500005555555559
        ...
        // the first record should be complete
        ResultRecord incompleteRecord = results.get(0);
        Assert.assertEquals("INCOMPLETE", incompleteRecord.getStatus());

        // the second should be incomplete
        ResultRecord completeRecord = results.get(1);
        Assert.assertEquals("CANCELLED", completeRecord.getStatus());
